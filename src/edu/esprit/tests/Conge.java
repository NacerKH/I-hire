...
class Conge {
  ...
  private Date DateValidation;
        ...
        //public Conge(int id, String type, String status, String description) {
public Conge(int id, String type, Date DateDebut, Date DateFin, String status, String description, Date DateValidation) {
       ...
       // public Conge(String type, String status, String description) {
...
//        return "Cong\u00e9{" + "id=" + id + ", type=" + type + ",  status=" + status + ", description=" + description + '}';
//    }
@Override
    public String toString() {
